# Project Title: __HCI Insights__
...
This web application strives to centralize the workflow of HCI/UX/UI research teams by facilitating the planning, execution, and analysis of usability studies. It handles participants, tasks, subtasks, sessions, results, studies, users, and analytics - all backed by a MySQL database that is exposed through a secure SpringBoot framework.
